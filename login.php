<?php include('includes/header--page.php'); ?>
    ...
    <main class="c-page">
       <div class="container-fluid p-0 d-flex">
            <div class="c-page__img position-absolute" style="background-image: url('assets/img/login-banner.jpg');"></div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <form class="row">
                                        ...
                                        <div class="mb-5">
                                            <a href="" class="text-decoration-none fw-b fs-6 d-block fw-500">Esqueceu sua senha?</a>
                                        </div>
