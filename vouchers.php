                ...
                <div class="container">
                    ...
                    <div class="row d-flex justify-content-end">
                        ...
                        <div class="col-lg-6">
                            ...
                            <h2 class="mb-4 fs-1 fw-bold text-secondary col-md-8 col-lg-10 col-xl-8 col-xxl-6">Informações sobre vouchers</h2>

                            <div class="row">
                                <div class="col-xl-7 col-md-7 fs-4">
                                    <p class="mb-5 fs-4 text-black-50">Confira todas as categorias de vouchers e como podemos ajudar com a geração de cada.</p>
                                </div>
                            </div>
                            <div class="row  mt-5">
                                <div class="col-xl-12">
                                    <div class="accordion accordion-flush border-top border-bottom border-secondary" id="accordionExample">
                                        <div class="accordion-item">
                                            ...
                                            <button class="accordion-button collapsed fw-500" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                                E-vouchers (Vouchers Eletrônicos)
                                            </button>
                                            </h2>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <button class="accordion-button collapsed fw-500" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                Vouchers emitidos por sua empresa
                                            </button>
                                            </h2>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed fw-500" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseThree">
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingFour">
                                            <button class="accordion-button collapsed fw-500" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseThree">
                                                Dados de facturamento
                                            </button>
                                            </h2>
