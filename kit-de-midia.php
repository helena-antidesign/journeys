<?php include('includes/header--white.php'); ?>
    ...
    <main class="c-page">
       <div class="container-fluid p-0 d-flex">
            <div class="c-page__img" style="background-image: url('assets/img/downloads-banner.jpg');"></div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <h3 class="mb-4 fs-1 fw-bold col-xl-11 text-secondary">Downloads & Kit De Mídia</h3>
