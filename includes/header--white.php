...
<body>
    <header class="o-header o-header--white position-fixed bg-white p-4">
        ...
        <nav class="navbar navbar-dark navbar-expand-lg">
            ...
            <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
                ...
                <ul class="nav align-items-center">
                    ...
                    <li>
                        <a href="login.php" class="text-reset bg-white text-secondary fs-6 ps-4 pe-2 rounded-pill d-flex align-items-center border border-white o-header__login"> 
