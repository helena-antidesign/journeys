...
<body>
    <header class="o-header o-header--white position-absolute bg-white p-4">
        <div class="container">
                    ...
                    <ul class="nav align-items-center o-header__navbar__login">
                        ...
                        <li class="nav-item">
                            <div class="o-header__language rounded-pill JS__header-language">
                                ...
                                <span class="icon-language cursor-pointer"></span>
                        ...
                        <li class="position-relative"  style="display: none;">
                            ...
                            <div class="o-header__login__content">
                                <span class="o-header__login__content__title fw-500 text-primary cursor-pointer" data-bs-toggle="modal" data-bs-target="#selecionarcliente">JOURNEYS - USO INTERNO OPERAÇÕES - INTERNACIONAL (USD)</span>
                                <a href="javascript:document.getElementById('logoutForm').submit()" class="text-decoration-underline">Sair</a>
                            </div>

                        </li>

                            <!-- SE USUÁRIO DESLOGADO -->
                        <li>
                            <a href="login.php" class="text-reset bg-white text-secondary fs-6 ps-4 pe-2 rounded-pill d-md-flex align-items-center border border-white o-header__login"> 
                                <span class="o-header__login__txt">Bem-Vindo </span>
