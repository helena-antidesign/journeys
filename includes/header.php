    ...
    <header class="o-header position-absolute p-4">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-header" aria-current="page" href="/" title="Journeys">
                ...
                <ul class="nav justify-content-end align-items-center">
                    <li class="nav-item">
                        <a class="nav-link text-light fs-6" href="brasil-secreto.php">Brasil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-6" href="sobre.php">Sobre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-6" href="relatorios.php">Relatórios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fs-6" href="reservas.php">Reservas</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li>
                        <a href="login.php" class="text-reset bg-white text-secondary fs-6 ps-4 pe-2 rounded-pill d-flex align-items-center border border-white"> 
