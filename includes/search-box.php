...
<div class="o-search-box bg-white JS__search-box">
        ...
        <div class="d-flex justify-content-between align-items-end position-relative">
            ...
            <div class="o-search-box__form__passageiros">
                ...
                <div class="o-search-box__form__passageiros__input">
                    ...
                    <span class="form-control JS__passageiros-input" id="passageirosInput" aria-label="Passageiros + Quarto/s"  onclick="openPassageiros()">
