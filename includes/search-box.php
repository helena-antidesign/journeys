...
<div class="o-search-box bg-white JS__search-box --hotel">
    ...
    <div class="o-search-box__title  JS__search-toggle">
        <span>Encontre o destino ideal</span> 
            
        <button class="o-search-box__title__toggle" type="button">
            <span class="icon-arrow-down fs-4 text-primary"></span>
        </button>

    </div>

    <div class="o-search-box__container JS__search-container">
        <div class="d-flex flex-wrap justify-content-end">
            <div class="o-search-box__radios">
        ...
        <div class="o-search-box__form">
            <div class="d-flex justify-content-between flex-wrap position-relative">
                ...
                <div class="o-search-box__form__regime JS__regime-input">
                ...
                <div class="o-search-box__form__data JS__searchBox-data">
                    ...
                    <input class="form-control bg-transparent" type="text" id="searchbox-datepicker" placeholder="Ida  - Volta">
                ...
                <div class="o-search-box__form__submit">
                    <button type="submit" class="btn btn-primary bottom-0 d-flex align-items-center justify-content-center">
