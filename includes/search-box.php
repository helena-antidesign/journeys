...
<div class="o-search-box bg-white JS__search-box --hotel">
        ...
        <div class="d-flex justify-content-between o-search-box__radios">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label d-flex align-items-center" for="search-tour">
                    <svg xmlns="http://www.w3.org/2000/svg"><g data-name="Grupo 1109"><g data-name="Retângulo 22" transform="translate(0 5.072)" fill="none" stroke="#676767" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><rect width="20" height="18.124" rx="4" stroke="none"/><rect x=".75" y=".75" width="18.5" height="16.624" rx="3.25"/></g><path data-name="Caminho 12" d="M6.766 8.708h6.546" fill="none" stroke="#676767" stroke-linecap="round" stroke-width="1.5"/><g data-name="Grupo 47" fill="none" stroke="#676767" stroke-linecap="round" stroke-width="2"><path data-name="Linha 14" d="M5.055 24.065V22.67"/><path data-name="Linha 15" d="M14.234 24.065V22.67"/></g><g data-name="Grupo 48" fill="none" stroke="#676767" stroke-linecap="round" stroke-width="1.5"><path data-name="Linha 4" d="M5.258 18.456v-6.534"/><path data-name="Linha 12" d="M10.01 18.456v-6.534"/><path data-name="Linha 13" d="M14.762 18.456v-6.534"/></g><path data-name="Caminho 11" d="M5.938 5.076V4.004a2.5 2.5 0 012.5-2.5h3.764a2.5 2.5 0 012.5 2.5v1.072h1.5V4.004a4 4 0 00-4-4H8.438a4 4 0 00-4 4v1.072z" fill="#676767"/></g></svg>
                    Tour
                </label>
            </div>
            <div class="form-check">
    ...
    <div class="o-search-box__form">
        <div class="d-flex justify-content-between align-items-end flex-wrap position-relative">
            ...
            <div class="o-search-box__form__destino">
                <label for="destinoInput" class="form-label">Qual é o destino?</label>
                <input class="form-control" type="text" id="destinoInput" placeholder="Busque por país, cidade, estado" aria-label="Busque por país, cidade, estado">
            </div>
            <div class="o-search-box__form__hotel">
                <label for="hotelInput" class="form-label">Qual Hotel?</label>
                <input class="form-control" id="hotelInput" type="text" placeholder="Qual hotel desejado (opcional)" aria-label="Qual hotel desejado (opcional)">
            </div>
            <div class="o-search-box__form__regime position-absolute JS__regime-input">
            ...
            <div class="o-search-box__form__passageiros">
            ...
            <div class="o-search-box__form__data JS__searchBox-data">
                ...
                <input class="form-control bg-transparent" type="text" id="datepicker" placeholder="Ida  - Volta">
                <label class="o-search-box__form__data__icon"> 
